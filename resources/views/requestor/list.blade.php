                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge rounded-pill bg-label-primary">Pending Payment</span>
                                </td>
                                <td>
                                    <a href="/requests/history/Tangol sa Quiapo" class="text-primary fs-5">
                                        <i class='bx bx-show'></i>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <a href="/requests/history/Panday panday" class="text-primary fs-5">
