 ...
 @section('content')
     <div class="col-12">
         <form action="{{ route('educations.update', ['id' => $student->id, 'educationId' => $education->id]) }}"
             method="post">
             @method('PUT')
             @csrf
             <div class="card">
                 <div class="card-body">
                     <h5 class="card-title mb-3">Education Background Information</h5>
                                         ...
                                         <optgroup label="{{ $program['level_name'] }}">
                                             @foreach ($program['major_names'] as $major)
                                                 <option value="{{ $major->id }}"
                                                     @if ($major->id == $education->major->id) selected @endif>
                                                     {{ ucwords($major->name) }}
                                                 </option>
                                             @endforeach
                                         </optgroup>
                         ...
                         <div class="col-lg-4 col-md-12">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="number" name="year_level" id="year_level"
                                     ...
                                     placeholder="Year Level" value="{{ $education->year_level }}">
                                 <div class="invalid-feedback">
                                     This field is required.
                                 </div>
                             </div>
                         ...
                         <div class="col-lg-4 col-md-12">
                             ...
                             <div class="form-group">
                                 ...
                                 <select name="is_graduated" id="is_graduated"
                                     ...
                                     <option value="0" @if ($education->is_graduated == 0) selected="selected" @endif>
                                         No
                                     </option>
                                     <option value="1" @if ($education->is_graduated == 1) selected="selected" @endif>
                                         Yes
                                     </option>
                                 </select>
                                 @error('is_graduated')
                         ...
                         <div class="col-lg-12 col-md-12">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="text" name="school_name" id="school_name"
                                     ...
                                     value="{{ $education->school_name }}" placeholder="School Name">
                                 <div class="invalid-feedback">
                                     This field is required.
                                 </div>
                             </div>
                         ...
                         <div class="col-lg-12 col-md-12">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="text" name="school_address" id="school_address"
                                     ...
                                     value="{{ $education->address }}" placeholder="School Address">
                                 <div class="invalid-feedback">
                                     This field is required.
                                 </div>
                             </div>
